...
from named_tuple_collection import namedtuple
# STI revision to allow Consume to work with Python 2.5
# The namedtuple class was re-written in Python 2.5
...
class FCCSDB():
    ...
    def __init__(self, fccs_file=""):
        ...
        if fccs_file == "":
            ...
            self.xml_file = os.path.join(mod_path, './input_data/fccs_loadings.xml')
